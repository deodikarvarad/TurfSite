...
function ProfilePage(){
    ...
    <div className="bg-orange-100">
        ...
        <div className="text-4xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-blue-500 via bg-voilet-500 to-indigo-500 pt-40 pl-36 underline">
            My Profile
        ...
        <div className="flex flex-row pt-14 pb-6 ml-40 mr-40 justify-between items-center ">
           ...
           <h2 className="pl-2">virat.kohli</h2>
           </div>
